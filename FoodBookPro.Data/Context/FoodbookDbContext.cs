...
namespace FoodBookPro.Data.Context
{
    public class FoodbookDbContext : DbContext
    {
        ...
        // XAV-34: Agregamos la tabla de restaurantes
        ...
        public void SeedData()
        {
            ...
            var restaurants = new List<Restaurant>
            {
                ...
                new Restaurant { Id = 2, Name = "Burger Galaxy", City = "Santiago", CuisineType = "Hamburguesas", Rating = 4.2, PriceRange = "$$", Distance = 2.3, ImageUrl = "https://images.unsplash.com/photo-1568901346375-23c9450c58cd?w=400" },
                new Restaurant { Id = 3, Name = "Sushi Master", City = "Santo Domingo", CuisineType = "Japonesa", Rating = 4.8, PriceRange = "$$$", Distance = 1.1, ImageUrl = "https://images.unsplash.com/photo-1579871494447-9811cf80d66c?w=400" },
                new Restaurant { Id = 4, Name = "Taco Loco", City = "La Romana", CuisineType = "Mexicana", Rating = 4.0, PriceRange = "$", Distance = 5.4, ImageUrl = "https://images.unsplash.com/photo-1565299585323-38d6b0865b47?w=400" },
                new Restaurant { Id = 5, Name = "El Rincón del Pollo", City = "Santo Domingo", CuisineType = "Criolla", Rating = 4.3, PriceRange = "$$", Distance = 0.8, ImageUrl = "https://images.unsplash.com/photo-1562967914-608f82629710?w=400" },
                new Restaurant { Id = 6, Name = "Pasta & Vino", City = "Punta Cana", CuisineType = "Italiana", Rating = 4.7, PriceRange = "$$$", Distance = 15.0, ImageUrl = "https://images.unsplash.com/photo-1473093226795-af9932fe5856?w=400" },
                new Restaurant { Id = 7, Name = "Veggie Delight", City = "Santo Domingo", CuisineType = "Vegetariana", Rating = 4.6, PriceRange = "$$", Distance = 3.2, ImageUrl = "https://images.unsplash.com/photo-1512621776951-a57141f2eefd?w=400" },
                new Restaurant { Id = 8, Name = "Steak House 85", City = "Santiago", CuisineType = "Carnes", Rating = 4.4, PriceRange = "$$$", Distance = 4.1, ImageUrl = "https://images.unsplash.com/photo-1544025162-d76694265947?w=400" },
                new Restaurant { Id = 9, Name = "Wok & Roll", City = "Santo Domingo", CuisineType = "Asiática", Rating = 4.1, PriceRange = "$$", Distance = 2.5, ImageUrl = "https://images.unsplash.com/photo-1512058560566-42724afbc2db?w=400" },
                new Restaurant { Id = 10, Name = "La Dulce Parada", City = "Puerto Plata", CuisineType = "Postres", Rating = 4.9, PriceRange = "$", Distance = 1.0, ImageUrl = "https://images.unsplash.com/photo-1551024601-bec78aea704b?w=400" },
                new Restaurant { Id = 11, Name = "Mariscos del Caribe", City = "Boca Chica", CuisineType = "Mariscos", Rating = 4.2, PriceRange = "$$", Distance = 30.5, ImageUrl = "https://images.unsplash.com/photo-1551489186-cf8726f514f8?w=400" },
